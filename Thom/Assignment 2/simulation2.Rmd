...
Now, we create 100 samples consisting of 1000 observations. 
...
Fortunately, we already created a function that extracts whatever we want to know from the samples. 
